...
import { Car, Shirt, ArrowRight, MapPin, Star, Zap, Phone, Sparkles } from "lucide-react";
  ...
  return (
    <section className="relative overflow-hidden bg-background min-h-screen">
      ...
      <div className="hero-gradient relative overflow-hidden">
        ...
        <div className="relative container max-w-lg mx-auto px-5 pt-8 pb-16">
          {/* Logo + Location */}
          <motion.div
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-primary-foreground/50 text-[11px] font-medium">Lavage · Vidange · Pressing</p>
              </div>
            </div>
            <motion.div
              initial={{ scale: 0 }}
              ...
              className="flex items-center gap-1 rounded-full bg-primary-foreground/15 backdrop-blur-sm px-2.5 py-1 border border-primary-foreground/20"
            >
          ...
          >
            <p className="text-primary-foreground/70 text-sm mb-5 leading-relaxed max-w-[260px] mx-auto">
            ...
            <div className="flex gap-3 justify-center">
              <Button
                variant="secondary"
                size="lg"
                className="rounded-2xl h-12 px-5 text-sm font-bold shadow-lg flex-1 max-w-[155px]"
              ...
              <Button
                size="lg"
                className="rounded-2xl h-12 px-5 text-sm font-bold border-2 border-primary-foreground/25 text-primary-foreground bg-primary-foreground/10 hover:bg-primary-foreground/20 shadow-lg flex-1 max-w-[155px]"
      ...
      <div className="container max-w-lg mx-auto px-4 -mt-7 relative z-10">
        <motion.div
          ...
          className="glass-card rounded-2xl p-3.5 flex items-center justify-around"
        >
          {[
...
const ServiceSection = ({ title, emoji, services, onSeeAll, onServiceClick, delay }: ServiceSectionProps) => (
  <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay }}>
    <div className="flex items-center justify-between mb-3">
      ...
      <button onClick={onSeeAll} className="text-xs font-semibold text-primary flex items-center gap-1">
    ...
    <div className="grid grid-cols-2 gap-3">
      {services.slice(0, 4).map((service, i) => (
        ...
        >
          <div className="w-10 h-10 rounded-xl hero-gradient flex items-center justify-center text-lg mb-2.5 shadow-sm">
            {service.icon}
          </div>
